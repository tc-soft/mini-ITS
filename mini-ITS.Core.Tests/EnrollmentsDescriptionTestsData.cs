...
namespace mini_ITS.Core.Tests
{
    public class EnrollmentsDescriptionTestsData
    {
        ...
        public static IEnumerable<EnrollmentsDescription> EnrollmentsDescriptionCases
        {
            get
            {
                yield return new EnrollmentsDescription
                {
                    ...
                    DateAddDescription = new DateTime(2024, 4, 1, 0, 0, 0),
                    DateModDescription = new DateTime(2024, 4, 1, 0, 0, 0),
                ...
                yield return new EnrollmentsDescription
                {
                    ...
                    EnrollmentId = new Guid("6AC164EC-C578-43EB-9B4A-0478C316DD03"),
                    DateAddDescription = new DateTime(2024, 4, 3, 0, 0, 0),
                    DateModDescription = new DateTime(2024, 4, 3, 0, 0, 0),
                ...
                yield return new EnrollmentsDescription
                {
                    ...
                    DateAddDescription = new DateTime(2024, 4, 7, 0, 0, 0),
                    DateModDescription = new DateTime(2024, 4, 7, 0, 0, 0),
                ...
                yield return new EnrollmentsDescription
                {
                    ...
                    EnrollmentId = new Guid("9F38B77C-3444-4E69-BF2E-C1A71E4B5B6E"),
                    DateAddDescription = new DateTime(2024, 4, 10, 0, 0, 0),
                    DateModDescription = new DateTime(2024, 4, 10, 0, 0, 0),
        ...
        public static IEnumerable<EnrollmentsDescriptionDto> EnrollmentsDescriptionCasesDto
        {
            get
            {
                var config = new MapperConfiguration(cfg => cfg.CreateMap<EnrollmentsDescription, EnrollmentsDescriptionDto>(), NullLoggerFactory.Instance);
