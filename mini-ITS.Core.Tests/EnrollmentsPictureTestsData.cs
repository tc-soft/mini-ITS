        ...
        public static IEnumerable<EnrollmentsPicture> EnrollmentsPictureCases
        {
            get
            {
                yield return new EnrollmentsPicture
                {
                    ...
                    DateAddPicture = new DateTime(2024, 4, 1, 0, 1, 0),
                    DateModPicture = new DateTime(2024, 4, 1, 0, 1, 0),
                    ...
                    PictureName = "20240401_000001.jpg",
                ...
                yield return new EnrollmentsPicture
                {
                    ...
                    DateAddPicture = new DateTime(2024, 4, 4, 0, 1, 0),
                    DateModPicture = new DateTime(2024, 4, 4, 0, 1, 0),
                    ...
                    PictureName = "20240404_000001.jpg",
                ...
                yield return new EnrollmentsPicture
                {
                    ...
                    DateAddPicture = new DateTime(2024, 4, 7, 0, 1, 0),
                    DateModPicture = new DateTime(2024, 4, 7, 0, 1, 0),
                    ...
                    PictureName = "20240407_000001.jpg",
                ...
                yield return new EnrollmentsPicture
                {
                    ...
                    EnrollmentId = new Guid("9F38B77C-3444-4E69-BF2E-C1A71E4B5B6E"),
                    DateAddPicture = new DateTime(2024, 4, 7, 0, 4, 0),
                    DateModPicture = new DateTime(2024, 4, 7, 0, 4, 0),
                    UserAddPicture = new Guid("DA38CA53-D59F-49FB-B5E8-4118A13AABD9"),
                    UserAddPictureFullName = "Louis Gilliam",
                    UserModPicture = new Guid("DA38CA53-D59F-49FB-B5E8-4118A13AABD9"),
                    UserModPictureFullName = "Louis Gilliam",

                    PictureName = "20240407_000004.jpg",
