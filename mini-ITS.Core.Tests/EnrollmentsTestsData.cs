        ...
        public static IEnumerable<Enrollments> EnrollmentsCases
        {
            get
            {
                yield return new Enrollments
                {
                    ...
                    DateEndDeclareByUser = new DateTime(2024, 3, 8, 7, 0, 0),
                ...
                yield return new Enrollments
                {
                    ...
                    DateEndEnrollment = null,
                    DateReeEnrollment = null,
                    DateEndDeclareByUser = new DateTime(2024, 3, 11, 7, 0, 0),
                    DateEndDeclareByDepartment = new DateTime(2024, 3, 11, 7, 0, 0),
                ...
                yield return new Enrollments
                {
                    ...
                    DateReeEnrollment = null,
                    DateEndDeclareByUser = new DateTime(2024, 3, 14, 7, 0, 0),
                    DateEndDeclareByDepartment = new DateTime(2024, 3, 14, 7, 0, 0),
                ...
                yield return new Enrollments
                {
                    ...
                    DateReeEnrollment = null,
                    DateEndDeclareByUser = new DateTime(2024, 3, 17, 7, 0, 0),
                    DateEndDeclareByDepartment = new DateTime(2024, 3, 17, 7, 0, 0),
                    DateEndDeclareByDepartmentUser = new Guid("6F929C62-3A50-4F29-AF99-F4D188754FC0"),
                    DateEndDeclareByDepartmentUserFullName = "Eva Pedrov",
                    Department = "IT",
