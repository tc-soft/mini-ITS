    ...
    public class EnrollmentsTestsData
    {
        ...
        public static IEnumerable<Enrollments> EnrollmentsCases
        {
            get
            {
                ...
                {
                    Id = new Guid("6ac164ec-c578-43eb-9b4a-0478c316dd03"),
                    Nr = 1,
                    Year = 2024,
                    DateAddEnrollment = new DateTime(2024, 3, 1, 7, 0, 0),
                    DateModEnrollment = new DateTime(2024, 3, 1, 7, 0, 0),
                    DateEndEnrollment = null,
                    DateReeEnrollment = null,
                    DateEndDeclareByUser = new DateTime(2024, 3, 8, 23, 59, 59),
                ...
                yield return new Enrollments
                {
                    Id = new Guid("d11a5a6b-f1fa-49d6-b412-f4addd7f7be5"),
                    Nr = 4,
                    Year = 2024,
                    DateAddEnrollment = new DateTime(2024, 3, 4, 7, 0, 0),
                    DateModEnrollment = new DateTime(2024, 3, 5, 7, 0, 0),
                    DateEndEnrollment = null,
                    DateReeEnrollment = null,
                    DateEndDeclareByUser = new DateTime(2024, 3, 11, 23, 59, 59),
                    DateEndDeclareByDepartment = new DateTime(2024, 3, 11, 23, 59, 59),
                ...
                yield return new Enrollments
                {
                    Id = new Guid("9f38b77c-3444-4e69-bf2e-c1a71e4b5b6e"),
                    Nr = 7,
                    Year = 2024,
                    DateAddEnrollment = new DateTime(2024, 3, 7, 7, 0, 0),
                    DateModEnrollment = new DateTime(2024, 3, 12, 7, 0, 0),
                    DateEndEnrollment = new DateTime(2024, 3, 12, 7, 0, 0),
                    DateReeEnrollment = null,
                    DateEndDeclareByUser = new DateTime(2024, 3, 14, 23, 59, 59),
                    DateEndDeclareByDepartment = new DateTime(2024, 3, 14, 23, 59, 59),
                ...
                yield return new Enrollments
                {
                    ...
                    Nr = 10,
                    Year = 2024,
                    DateAddEnrollment = new DateTime(2024, 3, 10, 7, 0, 0),
                    DateModEnrollment = new DateTime(2024, 3, 15, 7, 0, 0),
                    DateEndEnrollment = new DateTime(2024, 3, 15, 7, 0, 0),
                    DateReeEnrollment = null,
                    DateEndDeclareByUser = new DateTime(2024, 3, 17, 23, 59, 59),
                    DateEndDeclareByDepartment = new DateTime(2024, 3, 17, 23, 59, 59),
                    DateEndDeclareByDepartmentUser = new Guid("6F929C62-3A50-4F29-AF99-F4D188754FC0"),
                    DateEndDeclareByDepartmentUserFullName = "Eva Pedrov",
                    Department = "IT",
        ...
        public static IEnumerable<Enrollments> CRUDCases
        {
            get
            {
                yield return new Enrollments
                {
                    ...
                    DateEndEnrollment = null,
                    DateReeEnrollment = null,
                    DateEndDeclareByUser = new DateTime(2023, 9, 8, 23, 59, 59),
                    DateEndDeclareByDepartment = null,
                    DateEndDeclareByDepartmentUser = new Guid(),
                    DateEndDeclareByDepartmentUserFullName = null,
                    Department = "Managers",
                ...
                yield return new Enrollments
                {
                    ...
                    DateEndEnrollment = null,
                    DateReeEnrollment = null,
                    DateEndDeclareByUser = new DateTime(2023, 9, 9, 23, 59, 59),
                    DateEndDeclareByDepartment = null,
                    DateEndDeclareByDepartmentUser = new Guid(),
                    DateEndDeclareByDepartmentUserFullName = null,
                ...
                yield return new Enrollments
                {
                    ...
                    DateEndEnrollment = null,
                    DateReeEnrollment = null,
                    DateEndDeclareByUser = new DateTime(2023, 9, 10, 23, 59, 59),
                    DateEndDeclareByDepartment = null,
                    DateEndDeclareByDepartmentUser = new Guid(),
                    DateEndDeclareByDepartmentUserFullName = null,
                    Department = "Research",
                ...
                yield return new Enrollments
                {
                    ...
                    DateEndEnrollment = null,
                    DateReeEnrollment = null,
                    DateEndDeclareByUser = new DateTime(2023, 9, 11, 23, 59, 59),
                    DateEndDeclareByDepartment = null,
                    DateEndDeclareByDepartmentUser = new Guid(),
                    DateEndDeclareByDepartmentUserFullName = null,
                    Department = "IT",
