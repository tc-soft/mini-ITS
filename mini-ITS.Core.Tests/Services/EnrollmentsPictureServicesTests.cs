...
{
    [TestFixture]
    internal class EnrollmentsPictureServicesTests
    {
        ...
        [TestCaseSource(typeof(EnrollmentsPictureTestsData), nameof(EnrollmentsPictureTestsData.EnrollmentsPictureCasesDto))]
