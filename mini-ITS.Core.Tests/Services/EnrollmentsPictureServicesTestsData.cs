...
{
    public class EnrollmentsPictureServicesTestsData
    {
        public static IEnumerable<EnrollmentsPictureDto> EnrollmentsPictureCases
        {
            get
            {
                yield return new EnrollmentsPictureDto
                {
        ...
        public static IEnumerable<EnrollmentsPictureDto> CRUDCases
        {
            get
            {
                yield return new EnrollmentsPictureDto
