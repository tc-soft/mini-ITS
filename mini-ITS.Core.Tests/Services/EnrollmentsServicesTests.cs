...
namespace mini_ITS.Core.Tests.Services
{
    ...
    public class EnrollmentsServicesTests
    {
        ...
        [TestCaseSource(typeof(EnrollmentsServicesTestsData), nameof(EnrollmentsServicesTestsData.CRUDCases))]
        public async Task CreateAsync(EnrollmentsDto enrollmentsDto)
        {
            ...
            Assert.That(enrollmentDto.Id, Is.EqualTo(id), $"ERROR - {nameof(enrollmentsDto.Id)} is not equal");
        ...
        public async Task UpdateAsync(EnrollmentsDto enrollmentsDto)
        {
            ...
            Assert.IsNotNull(enrollmentDto.Year, $"ERROR - {nameof(enrollmentsDto.Year)} is null");
            Assert.IsNotNull(enrollmentDto.DateAddEnrollment, $"ERROR - {nameof(enrollmentsDto.DateAddEnrollment)} is null");
            Assert.IsNull(enrollmentDto.DateEndEnrollment, $"ERROR - {nameof(enrollmentsDto.DateEndEnrollment)} is not null");
            Assert.IsNotNull(enrollmentDto.DateLastChange, $"ERROR - {nameof(enrollmentsDto.DateLastChange)} is null");
            Assert.That(enrollmentDto.DateEndDeclareByUser, Is.EqualTo(enrollmentsDto.DateEndDeclareByUser), $"ERROR - {nameof(enrollmentsDto.DateEndDeclareByUser)} is not equal");
            Assert.That(enrollmentDto.DateEndDeclareByDepartment, Is.EqualTo(enrollmentsDto.DateEndDeclareByDepartment), $"ERROR - {nameof(enrollmentsDto.DateEndDeclareByDepartment)} is not equal");
            Assert.That(enrollmentDto.DateEndDeclareByDepartmentUser, Is.EqualTo(enrollmentsDto.DateEndDeclareByDepartmentUser), $"ERROR - {nameof(enrollmentsDto.DateEndDeclareByDepartmentUser)} is not equal");
            ...
            enrollmentDto.DateLastChange = DateTime.UtcNow;
            ...
            Assert.IsNotNull(enrollmentDto.Id, $"ERROR - {nameof(enrollmentDto.Id)} is null");
            Assert.IsNotNull(enrollmentDto.Nr, $"ERROR - {nameof(enrollmentDto.Nr)} is null");
            Assert.IsNotNull(enrollmentDto.Year, $"ERROR - {nameof(enrollmentDto.Year)} is null");
            Assert.IsNotNull(enrollmentDto.DateAddEnrollment, $"ERROR - {nameof(enrollmentDto.DateAddEnrollment)} is null");
            Assert.IsNull(enrollmentDto.DateEndEnrollment, $"ERROR - {nameof(enrollmentsDto.DateEndEnrollment)} is not null");
            Assert.IsNotNull(enrollmentDto.DateLastChange, $"ERROR - {nameof(enrollmentDto.DateLastChange)} is null");
            Assert.IsNotNull(enrollmentDto.DateEndDeclareByUser, $"ERROR - {nameof(enrollmentDto.DateEndDeclareByUser)} is null");
            ...
            Assert.IsNotNull(enrollmentDto.Department, $"ERROR - {nameof(enrollmentDto.Department)} is null");
            Assert.IsNotNull(enrollmentDto.Description, $"ERROR - {nameof(enrollmentDto.Description)} is null");
            Assert.IsNotNull(enrollmentDto.Group, $"ERROR - {nameof(enrollmentDto.Group)} is null");
            Assert.IsNotNull(enrollmentDto.Priority, $"ERROR - {nameof(enrollmentDto.Priority)} is null");
            Assert.IsNotNull(enrollmentDto.SMSToUserInfo, $"ERROR - {nameof(enrollmentDto.SMSToUserInfo)} is null");
            Assert.IsNotNull(enrollmentDto.SMSToAllInfo, $"ERROR - {nameof(enrollmentDto.SMSToAllInfo)} is null");
            Assert.IsNotNull(enrollmentDto.MailToUserInfo, $"ERROR - {nameof(enrollmentDto.MailToUserInfo)} is null");
            Assert.IsNotNull(enrollmentDto.MailToAllInfo, $"ERROR - {nameof(enrollmentDto.MailToAllInfo)} is null");
            Assert.IsNotNull(enrollmentDto.ReadyForClose, $"ERROR - {nameof(enrollmentDto.ReadyForClose)} is null");
            Assert.That(enrollmentDto.State, Is.EqualTo("Assigned"), $"ERROR - {nameof(enrollmentDto.State)} is not equal");
            Assert.IsNotNull(enrollmentDto.UserAddEnrollment, $"ERROR - {nameof(enrollmentDto.UserAddEnrollment)} is null");
            Assert.IsNotNull(enrollmentDto.UserAddEnrollmentFullName, $"ERROR - {nameof(enrollmentDto.UserAddEnrollmentFullName)} is null");
            Assert.That(enrollmentDto.UserEndEnrollment, Is.EqualTo(new Guid()), $"ERROR - {nameof(enrollmentDto.UserEndEnrollment)} guid is not empty");
            Assert.IsNull(enrollmentDto.UserEndEnrollmentFullName, $"ERROR - {nameof(enrollmentDto.UserEndEnrollmentFullName)} is not null");
            Assert.That(enrollmentDto.UserReeEnrollment, Is.EqualTo(new Guid()), $"ERROR - {nameof(enrollmentDto.UserReeEnrollment)} guid is not empty");
            Assert.IsNull(enrollmentDto.UserReeEnrollmentFullName, $"ERROR - {nameof(enrollmentDto.UserReeEnrollmentFullName)} is not null");
            Assert.IsNotNull(enrollmentDto.ActionRequest, $"ERROR - {nameof(enrollmentDto.ActionRequest)} is null");
            Assert.IsNotNull(enrollmentDto.ActionExecuted, $"ERROR - {nameof(enrollmentDto.ActionExecuted)} is null");
            Assert.IsNotNull(enrollmentDto.ActionFinished, $"ERROR - {nameof(enrollmentDto.ActionFinished)} is null");
