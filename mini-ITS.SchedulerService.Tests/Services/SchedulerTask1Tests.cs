...
namespace mini_ITS.SchedulerService.Tests.Services
{
    ...
    public class SchedulerTask1Tests
    {
        ...
        {
            var task = new SchedulerTask1(_optionsMonitor, _logger, _serviceProvider, _holidayHelper);
        ...
        public void InvalidScheduleTest(string schedule)
        {
            ...
            Assert.Throws<FormatException>(() => new SchedulerTask1(_optionsMonitor, _logger, _serviceProvider, _holidayHelper),
        ...
        {
            _optionsMonitor.CurrentValue["SchedulerTask1"].Active = true;
            _optionsMonitor.CurrentValue["SchedulerTask1"].ActiveOnHolidays = false;
            _optionsMonitor.CurrentValue["SchedulerTask1"].Days = 2;
            ...
            _mockEnrollmentsServices
                ...
                .ReturnsAsync(new List<EnrollmentsDto>
                {
                    ...
                    {
                        State = "New",
                        DateAddEnrollment = testDate.AddDays(-3)
                    }
                });
