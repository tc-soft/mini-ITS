...
namespace mini_ITS.SchedulerService.Tests.Services
{
    ...
    public class SchedulerTask2Tests
    {
        ...
        {
            var task = new SchedulerTask2(_optionsMonitor, _logger, _serviceProvider);
        ...
        public void InvalidScheduleTest(string schedule)
        {
            ...
            Assert.Throws<FormatException>(() => new SchedulerTask2(_optionsMonitor, _logger, _serviceProvider),
