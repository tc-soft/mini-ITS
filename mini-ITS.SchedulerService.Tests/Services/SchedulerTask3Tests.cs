...
namespace mini_ITS.SchedulerService.Tests.Services
{
    ...
    public class SchedulerTask3Tests
    {
        ...
        {
            var task = new SchedulerTask3(_optionsMonitor, _logger, _serviceProvider, _holidayHelper);
        ...
        public void InvalidScheduleTest(string schedule)
        {
            ...
            Assert.Throws<FormatException>(() => new SchedulerTask3(_optionsMonitor, _logger, _serviceProvider, _holidayHelper),
        ...
        {
            _optionsMonitor.CurrentValue["SchedulerTask3"].Active = true;
            _optionsMonitor.CurrentValue["SchedulerTask3"].ActiveOnHolidays = false;
            _optionsMonitor.CurrentValue["SchedulerTask3"].Days = 2;
